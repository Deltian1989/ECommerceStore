...
namespace ECommerceStore.Infrastructure.Persistence
{
    public class ApplicationDbContext : DbContext
    {
        ...
        private void SaveProducts(List<Product> products, DbContext context)
        {
            foreach (var product in products)
            {
                var productEntity = context.Set<Product>().FirstOrDefault(p => p.Id == product.Id);
